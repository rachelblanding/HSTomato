...
#Create MDS Plot
plotMDS(dgeSD, main="M-C and H-C MDS plot")
...
col.cell <- c("purple","orange", "darkgreen","grey","red","blue")[MCHCData$`H1-C.bam`]
?data.frame
