...
legend("topleft",fill=c("purple","orange"),legend=infodata$Geneid))
# Add a title
title("N-C and H-C DNA MDS Plot")

# Similarly for status
levels(NCHCData$`N1-C.bam`)
...
col.cell <- c("purple","orange")[ShortData2$`H1-C.bam`]
col.cell
