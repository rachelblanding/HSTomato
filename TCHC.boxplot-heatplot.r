...
#Create MDS Plot
plotMDS(dgeSD, main="T-C and H-C MDS plot")
...
col.cell <- c("purple","orange", "darkgreen","grey","red","blue")[TCHCData$`H1-C.bam`]
?data.frame
...
title("T-C and H-C DNA MDS Plot")
